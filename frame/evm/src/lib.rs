...
/// Custom config based off Istanbul Hard fork config with higher create contract limit
pub const fn istanbul() -> Config {
	Config {
		...
		create_contract_limit: Some(0x8000),
		call_stipend: 2300,
...
static ISTANBUL_CONFIG: Config = istanbul();
